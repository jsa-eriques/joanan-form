...
import imgApp1 from "../assets/mz/background/Antedimento.png";
import imgApp2 from "../assets/mz/background/CRM Atendimento.png";
import imgApp3 from "../assets/mz/background/Gestor.png";
import imgApp4 from "../assets/mz/background/cell-chat.png";
import imgApp5 from "../assets/mz/background/cell-atendimento2.png";
import imgApp6 from "../assets/mz/background/Sem título.png";
  ...
  return (
    <>
      <div class="overflow-hidden overflow-x-hidden">
        <img
          class="-z-50 absolute overflow-hidden opacity-50 left-3.5 w-3/4"
          src={circleBlur}
          alt="Javascript"
        />
      </div>
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mm:h-[100vh] sm:h-[100vh] md:h-[92vh]">
        <nav
          class="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 mm:grid-cols-1 gap-2 sm:gap-4"
          aria-label="Tabs"
          role="tablist"
        >
          <button
          ...
          >
            <span class="md:flex">
              <svg
                class=" md:block flex-shrink-0 md:mt-2 h-6 w-6 hs-tab-active:text-blue-600 text-gray-500 dark:hs-tab-active:text-blue-500 dark:text-gray-500"
              ...
              <span class="md:grow md:ml-5">
                ...
                <span class="lg:block mt-2 text-gray-800 dark:text-gray-200">
                  Melhore a organização dos atendimentos com nossa plataforma
                  multicanal e ferramentas de agilidade.
                </span>
              </span>
            </span>
          </button>
          ...
          >
            <span class="md:flex">
              ...
              <span class="md:grow md:ml-5">
                ...
                <span class="lg:block mt-2 text-gray-800 dark:text-gray-200">
                  Otimize seguimento, registre detalhes e aprimore a satisfação
                  do cliente."
                </span>
              </span>
            </span>
          ...
          >
            <span class="md:flex">
              ...
              <span class="hs-tab-active:text-blue-600 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                  ...
                  <span class="lg:block mt-2 text-gray-800 dark:text-gray-200">
                    O gestor consegue acompanhar tudo que acontece nos atendimentos
                    da sua empresa por meio de metricas.
                  </span>
              </span>
            </span>
          </button>
